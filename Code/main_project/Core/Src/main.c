...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, Buzzer_Pin|Incinerator_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : Dosimeter_Pin */
  GPIO_InitStruct.Pin = Dosimeter_Pin;
  ...
  /*Configure GPIO pin : Incinerator_Pin */
  GPIO_InitStruct.Pin = Incinerator_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(Incinerator_GPIO_Port, &GPIO_InitStruct);
